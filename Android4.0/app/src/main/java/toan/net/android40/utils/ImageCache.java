...
// This class hold our bitmap image caches(memory and disk)
public class ImageCache {
    private static final String TAG = "ImageCache";
    private LruCache<String, Bitmap> mMemoryCache;

    /**
     * Creating a new ImageCache objec using the specified parameters.
     *
     * @param memCacheSizePercent The cache size as a percent of a variable app memory
     */
